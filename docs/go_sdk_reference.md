...
- [type Client](<#Client>)
  ...
  - [func \(c \*Client\) CreateSandbox\(ctx context.Context, template, namespace string\) \(\*Sandbox, error\)](<#Client.CreateSandbox>)
...
### func [NewTracerProvider](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/tracing.go#L51>)
...
<a name="CallOption"></a>
### type [CallOption](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/types.go#L69>)
...
#### func [WithMaxAttempts](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/types.go#L89>)
...
#### func [WithTimeout](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/types.go#L78>)
...
<a name="Client"></a>
### type [Client](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/client.go#L38-L48>)
...
<a name="NewClient"></a>
#### func [NewClient](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/client.go#L51>)
...
#### func \(\*Client\) [CreateSandbox](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/client.go#L80>)
...
#### func \(\*Client\) [DeleteAll](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/client.go#L219>)
...
#### func \(\*Client\) [DeleteSandbox](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/client.go#L201>)
...
#### func \(\*Client\) [EnableAutoCleanup](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/client.go#L235>)
...
#### func \(\*Client\) [GetSandbox](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/client.go#L112>)
...
#### func \(\*Client\) [ListActiveSandboxes](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/client.go#L169>)
...
#### func \(\*Client\) [ListAllSandboxes](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/client.go#L185>)
...
<a name="Commands"></a>
### type [Commands](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/commands.go#L32-L40>)
...
#### func \(\*Commands\) [Run](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/commands.go#L51>)
...
### type [ConnectionStrategy](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/strategy.go#L20-L23>)
...
### type [DirectStrategy](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/strategy.go#L26-L28>)
...
#### func \(\*DirectStrategy\) [Close](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/strategy.go#L31>)
...
#### func \(\*DirectStrategy\) [Connect](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/strategy.go#L30>)
...
### type [ExecutionResult](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/types.go#L123-L127>)
...
<a name="FileEntry"></a>
### type [FileEntry](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/types.go#L138-L143>)
...
<a name="FileType"></a>
### type [FileType](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/types.go#L130>)
...
<a name="Files"></a>
### type [Files](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/files.go#L72-L82>)
...
#### func \(\*Files\) [Exists](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/files.go#L238>)
...
<a name="Files.List"></a>
#### func \(\*Files\) [List](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/files.go#L189>)
...
<a name="Files.Read"></a>
#### func \(\*Files\) [Read](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/files.go#L145>)
...
#### func \(\*Files\) [Write](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/files.go#L90>)
...
<a name="HTTPError"></a>
### type [HTTPError](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/types.go#L54-L58>)
...
#### func \(\*HTTPError\) [Error](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/types.go#L60>)
...
<a name="Handle"></a>
### type [Handle](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/types.go#L101-L112>)
...
<a name="Info"></a>
### type [Info](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/types.go#L115-L120>)
...
<a name="K8sHelper"></a>
### type [K8sHelper](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/k8s.go#L52-L61>)
...
#### func [NewK8sHelper](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/k8s.go#L66>)
...
<a name="Key"></a>
### type [Key](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/client.go#L32-L35>)
...
<a name="Options"></a>
### type [Options](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/options.go#L44-L139>)
...
<a name="Sandbox"></a>
### type [Sandbox](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L32-L55>)
...
<a name="New"></a>
#### func [New](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L65>)
...
#### func \(\*Sandbox\) [Annotations](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L554>)
...
#### func \(\*Sandbox\) [ClaimName](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L536>)
...
#### func \(\*Sandbox\) [Close](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L367>)
...
#### func \(\*Sandbox\) [Commands](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L511>)
...
#### func \(\*Sandbox\) [Disconnect](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L469>)
...
#### func \(\*Sandbox\) [Exists](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L530>)
...
#### func \(\*Sandbox\) [Files](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L514>)
...
#### func \(\*Sandbox\) [IsReady](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L506>)
...
#### func \(\*Sandbox\) [List](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L527>)
...
#### func \(\*Sandbox\) [Open](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L175>)
...
#### func \(\*Sandbox\) [PodName](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L548>)
...
#### func \(\*Sandbox\) [Read](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L524>)
...
#### func \(\*Sandbox\) [Run](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L518>)
...
#### func \(\*Sandbox\) [SandboxName](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L542>)
...
#### func \(\*Sandbox\) [Write](<https://github.com/drogovozDP/agent-sandbox/blob/main/clients/go/sandbox/sandbox.go#L521>)
